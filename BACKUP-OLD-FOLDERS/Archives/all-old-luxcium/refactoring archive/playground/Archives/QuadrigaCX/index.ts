...
import request from 'request'; // QuadrigaCX API
...
function currentTradingInformation(res, book = 'btc_cad') {
  return request
    .get(`https://api.quadrigacx.com/v2/ticker?book=btc_cad`)
...
export default currentTradingInformation;
