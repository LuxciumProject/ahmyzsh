...
alias play4_dialog-question='(play -qv 0.5 "${LOCALSOUNDS}/miui/dialog-question.ogg")'
alias play2_dialog-warning='(play -qv 0.5 "${LOCALSOUNDS}/miui/dialog-warning.ogg")'
