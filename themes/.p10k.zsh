# Generated by Powerlevel10k configuration wizard on 2020-12-28 at 09:51 EST.
...
# blurred heads, blurred tails, 2 lines, dotted, full frame, lightest-ornaments, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK}_VIINS_CONTENT_EXPANSION='❯'
  # Default prompt symbol error.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{ERROR}_VIINS_CONTENT_EXPANSION='⌃'
  ...
  # really need it.
  typeset -g POWERLEVEL9K_DISABLE_HOT_RELOAD=false # TODO: change back to true
