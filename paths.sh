function personal_projects_aliases() {
    personal_projects_paths

    # /Users/neb_401/.vscode-insiders/extensions/dev-pop-n-lock-theme-vscode
    alias popnlock="cd ${DEV_POPNLOCK}"
    alias lxpop="cd ${DEV_POPNLOCK}"
    alias lxi="cd ${LXIO}"
    alias lxq="cd  ${LXI_QT_TS}"
    alias lxz="cd  ${AHMYZSH}"

    # alias popnlock="cd ${DEV_POPNLOCK}"
    # alias lxpop="cd ${DEV_POPNLOCK}"
    alias lxic="code ${LXIO}; cd ${LXIO}"
    alias lxqc="code ${LXI_QT_TS}; cd  ${LXI_QT_TS}"
    alias lxzc="code ${AHMYZSH}; cd  ${AHMYZSH}"
}
...
function personal_projects_paths() {
    ...
    export PATH_CODE_EXT="${HOME}/.vscode/extensions"
    # /Users/neb_401/.vscode-insiders/extensions
    export PATH_INSD_CODE_EXT="${HOME}/.vscode-insiders/extensions"
    {
        export DEV_POPNLOCK="${PATH_INSD_CODE_EXT}/dev-pop-n-lock-theme-vscode"
    ...
    export DEVELOPER="${HOME}/Developer"
    {
        ...
        export PATH_LXIO_PRJ="${LXI_PROJECT}"
        {
